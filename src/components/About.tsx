    ...
    <div id="about">
      <div className="items-container">
        ...
        <p>
             ...
             I am actively looking for my first professional data engineering role
             and eager to bring both technical depth and a strong problem-solving mindset to a driven team.
        </p>
      </div>
    </div>
  );
